...
--
-- Table structure for table `galaxy_attacks`
--
...
INSERT INTO `galaxy_config` (`config_key`, `config_value`) VALUES ('Version', '0.4.6') ON DUPLICATE KEY UPDATE `config_value`='x';
