...
if (! ($Colony && checkplace('market'))) $errors .= $Lang['NotAvailable'].'<br />';
...
// ===========================================================================
	...
	foreach (array('silicon', 'metal', 'uran', 'plutonium', 'deuterium', 'food', 'crystals') as $s) {
		...
		if ($place[$s.'buy'] || $place[$s.'sell']) {
			...
			if ($place[$s.'buy']) {
				...
				echo '<input name="amount" size="5" value="'.$max.'">&nbsp;<input type="submit" value="'.$Lang['Buy'].'"><br /><br /><b>Max</b>: <font class="capacity">'.div($max).'</font><br /></form>';
			}
			else echo '&nbsp;';
			...
			if ($place[$s.'sell']) {
				...
				echo '<input type="hidden" name="name" value="'.$s.'">';
				echo '<input name="amount" size="5" value="'.$max.'">&nbsp;<input type="submit" value="'.$Lang['Sell'].'"><br /><br /><b>Max</b>: <font class="result">'.div($max).'</font><br /></form>';
			}
			else echo '&nbsp;';
