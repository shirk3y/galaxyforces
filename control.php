...
// Planet info
	...
	$res = $db->query("SELECT SUM(colonists) AS pop FROM {$prefix}colonies WHERE planet='${Player['planet']}';");
	$pop = $db->fetchrow($res);
		...
		if ($t['type'] == 'planet') {
			...
			echo "\t<b>${Lang['Population']}</b>: <font class=\"result\">".strdiv((int)$pop['pop'])."</font><br />\n";
		}
